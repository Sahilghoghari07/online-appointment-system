...
<?php
    ...
    {
        $sql = "select * from patient_reg where username='". $_REQUEST["uname"] ."' and password ='". $_REQUEST["pass"] ."'";
        $date = mysqli_query($conn, $sql);
        $check = mysqli_num_rows($date);
        if($check == 1)
        {
             $_SESSION['userrname'] = $_REQUEST["uname"];
        ...
        <div class="container">
            ...
            <div class="part">
                <div class="left">
                    ...
                    <input type="submit" value="Sign In" name="signin" class="btn btn-primary col-12">
                    <p>Don't have an account? <a href="register.php">Register here</a><br></p>
                </div>
                <div class="right">
