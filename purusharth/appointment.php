...
<head>
    ...
    <title>Appointment - Purusharth</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="right">
            <ul>
                ...
                <li><a href="appointment.php" id="active">APPOINTMENT</a></li>
    ...
    <main>
        <div class="container">
            <div class="row">
                <a href="department.php" class="btn btn-primary col-6">
                    <h5><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        ...
                        </svg><i class="bi bi-calendar3"></i> Book Appointment ></h5>
                </a>
            </div>
            <h2 class="text-center">Appointment History</h2>
            <div class="row">
                <?php
                    $result = $conn -> query("select * from appointment where username='".$_SESSION["userrname"]."'");
                ...
                <div class="card bg-light my-3" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <h5><?php echo "Dr. " .$row["doctor"];?></h5>
                        <p id="time"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-clock-fill" viewBox="0 0 16 16">
                                <path
                                    d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71z" />
                            </svg><i class="bi bi-clock-fill"></i>
                            <?php echo $row["date"]." , ".$row["time"];?></p>
                    </div>
                </div>
                <?php }
                    ?>
    ...
    <footer>
        <div class="foot">
            ...
            <div class="menu">
                ...
                <p><a href="appointment.php" id="active">Appointment</a></p>
