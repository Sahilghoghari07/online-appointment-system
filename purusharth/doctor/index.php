...
<head>
    ...
    <title>Dashboard Doctor - Purusharth</title>
    ...
    *::-webkit-scrollbar {
    ...
    .container .part .card a {
        text-decoration: none;
        color: #c8c8c8;
    }

    .container .part .card a:hover {
        color: white;
    }
    </style>
</head>
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="right">
            <ul>
                <li><a href="drindex.php" id="active">HOME</a></li>
            ...
            <div class="part">
                <div class="card" style="width: 20rem;">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <?php
                             $doc = $conn->query("select name from doctor_reg where uname = '".$_SESSION['doctorname']."'");
                             $row = $doc->fetch_assoc();
                             $docname = $row["name"];
                            $result = $conn->query("select * from appointment where doctor='".$docname."' ");
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            $date = date("d M");
                             ...
                             $row = $doc->fetch_assoc();
                             $docname = $row["name"];
                            $result = $conn->query("select * from appointment where doctor='".$docname."' and date = '".$date."' ");
                            if ($row = mysqli_num_rows($result)) {
                                echo $row;
                            } else {
                                echo "0";
                        ...
                        <hr>
                        <a href="tappointment.php">View All ></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer>
        <div class="foot">
            ...
            <div class="menu">
                <h2>Useful Links</h2>
                <p><a href="drindex.php" id="active">Home</a></p>
                <p><a href="department.php">Appointment</a></p>
