...
<head>
    ...
    <title>Appointment Doctor - Purusharth</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="right">
            <ul>
                ...
                <li><a href="login_ad.php">LOGOUT</a></li>
            </ul>
        </div>
    ...
    <main>
        ...
        ?>
        <div class="container">
            <h2 class="text-center my-5 ">Appointment</h2>
            <div class="table">
                <table class="table table-striped text-center">
                    ...
                    <?php
                        ...
                        $docname = $row["name"];
                        $tdat = date('d M');
                        $result = $conn->query("select * from appointment where doctor='".$docname."' and date = '".$tdat."'");
    ...
    <footer>
        <div class="foot">
            ...
            <div class="menu">
                ...
                <p><a href="department.php" id="active">Appointment</a></p>
                <p><a href="login_ad.php">Logout</a></p>
            </div>
            <div class="contact">
                <h2>Contact</h2>
                <div class="location">
