...
<head>
    ...
    <title>Contact - Purusharth</title>
    ...
    <main>
        <form method="post">
            <div class="container">
                ...
                <div class="input-group">
                    <input type="tel" name="mono" placeholder="Enter your mo. no." class="form-control">
                </div>
                ...
                <div class="input-group">
                    <textarea name="query" class="form-control" rows="5" placeholder="Tell about your query"></textarea>
                </div>
                <div class="input-group">
    ...
    <footer>
        <div class="foot">
            ...
            <div class="menu">
                ...
                <p><a href="contact.php" id="active">Contact us</a></p>
