...
<head>
    ...
    <title>Login Admin - Purusharth</title>
    <style>
    *::-webkit-scrollbar {
        display: none;
    }
...
<body>
    ...
    {
        $sql = "select * from admin where username='". $_REQUEST["uname"] ."' and password ='". $_REQUEST["pass"] ."'";
        ...
        <div class="container">
            ...
            <div class="part">
                <div class="left">
                    ...
                    <div class="row">
                        <!-- <input type="submit" value="Login As Doctor" name="signind" class="btn btn-primary col-5"> -->
                        <input type="submit" value="Login As Admin" name="signina" class="btn col-12" id="btn">
                    </div>
