...
<head>
    ...
    <title>Dashboard Admin - Purusharth</title>
        ...
        <div class="container">
            <div class="maindash">
                <div class="left">
                    <h2>Welcome!</h2>
                    <h2>Admin</h2>
                    <p>Maintain your department carefully. <br>Have a nice day.</p>
                </div>
                <div class="right">
                    <div class="dash">
                        ...
                        <script>
                        var xValues = ["Doctor", "Patient", "Appointment"];
