...
<head>
    ...
    <title>Patient Admin - Purusharth</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="right">
            <ul>
                ...
                <li><a href="patient.php" id="active">PATIENT</a></li>
    ...
    <main>
        ...
        <form action="doctor.php" method="post">
            <div class="container">
                <h2 class="text-center my-5">Patient</h2>
                <div class="row">
                    <?php
                ...
                ?>
                    <div class="card bg-light my-3" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p id="co"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
