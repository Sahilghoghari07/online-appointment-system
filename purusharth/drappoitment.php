...
<head>
    ...
    <title>Book Appointment - Purusharth</title>
    ...
    <main>
        <?php
            ...
            if(isset($_REQUEST["book"])){
                $conn->query("insert into appointment values(NULL , '".$_SESSION['userrname']."','" .$_REQUEST['docdept']. "','" .$_REQUEST['drname']. "','" .$_REQUEST['date']. "','" .$_REQUEST['time']. "','".$_REQUEST['mono']."')");
                echo "<script>
        ...
        ?>
        <div class="container">
            <form action="drappoitment.php" method="POST">
                <h2 class="text-center">Book Appointment</h2>
                <div class="row">
                    <?php
                   $result = $conn -> query("select * from doctor_reg where name='".$_REQUEST["drname"]."' ");
                    while($row = $result -> fetch_assoc())
                    {
                ?>
                    <div class="card bg-light my-3" style="width: 25rem;">
                        <!-- <img src="./img/doctor.png" class="card-img-top"> -->
                        <div class="card-body"> 
                            <h4 class="card-title">Dr. <?php echo $row["name"];?></h4>
                            <h5><?php echo $row["department"];?><br></h5>
                            <input hidden type="text" name="drname" value="<?php echo $drname ?>">
                            <input hidden type="text" name="docdept" value="<?php  echo $row['department'] ?>">
                        </div>
                    </div>
                    <?php }
                ?>
                ...
                <div class="day">
                    ...
                    <div class="row my-3">
                        ...
                        <select name="date" id="" class="form-control ">
                            <option value="<?php $date->modify('+1 days');
                        $futuredate = $date->format('d M');
                        echo $futuredate;?>"> <?php echo $futuredate; ?> </option>
                ...
                <div class="time">
                    ...
                    <div class="row my-3">
                        ...
                        <select name="time" id="" class="form-control">
                            <option value="<?php $time->modify('+1 hours');
                        $futuredate = $time->format('h A');
                        echo $futuredate;?>"><?php echo $futuredate; ?></option>
                    ...
                    <div class="mono">
                        ...
                        <input type="text" placeholder="XXXXX XXXXX" maxlength="10" name="mono" class="form-control">
                    </div>
                    <button type="submit" name="book" class="btn btn-primary col-12 my-4">Book Appointment</button>
                </div>
            </form>
    </main>
    <footer>
